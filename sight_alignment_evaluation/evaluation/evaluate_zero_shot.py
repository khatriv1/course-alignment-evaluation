# sight_alignment_evaluation/evaluation/evaluate_zero_shot.py
...
from prompting.zero_shot import get_zero_shot_prediction_all_categories
...
def evaluate_zero_shot(data_path: str, api_key: str, output_dir: str = "results/zero_shot", limit: int = None):
    """Evaluate Zero-shot prompting technique on SIGHT dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_cats = get_zero_shot_prediction_all_categories(
                comment=row['comment'],
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Zero-shot evaluation on SIGHT dataset...")

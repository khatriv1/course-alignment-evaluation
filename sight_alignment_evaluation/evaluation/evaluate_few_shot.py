# sight_alignment_evaluation/evaluation/evaluate_few_shot.py
...
from prompting.few_shot import get_few_shot_prediction_all_categories
...
def evaluate_few_shot(data_path: str, api_key: str, output_dir: str = "results/few_shot", limit: int = None):
    """Evaluate Few-shot prompting technique on SIGHT dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_cats = get_few_shot_prediction_all_categories(
                comment=row['comment'],
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Few-shot evaluation on SIGHT dataset...")

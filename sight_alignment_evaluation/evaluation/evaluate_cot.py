# sight_alignment_evaluation/evaluation/evaluate_cot.py
...
from prompting.cot import get_cot_prediction_all_categories
...
def evaluate_cot(data_path: str, api_key: str, output_dir: str = "results/cot", limit: int = None):
    """Evaluate Chain of Thought prompting technique on SIGHT dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_cats = get_cot_prediction_all_categories(
                comment=row['comment'],
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Chain of Thought evaluation on SIGHT dataset...")

# sight_alignment_evaluation/evaluation/evaluate_self_consistency.py
...
from prompting.self_consistency import get_self_consistency_prediction_all_categories
...
def evaluate_self_consistency(data_path: str, api_key: str, output_dir: str = "results/self_consistency", limit: int = None):
    """Evaluate Self-Consistency prompting technique on SIGHT dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_cats = get_self_consistency_prediction_all_categories(
                comment=row['comment'],
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Self-Consistency evaluation on SIGHT dataset...")

# sight_alignment_evaluation/evaluation/evaluate_auto_cot.py
...
from prompting.auto_cot import get_auto_cot_prediction_all_categories
...
def evaluate_auto_cot(data_path: str, api_key: str, output_dir: str = "results/auto_cot", limit: int = None):
    """Evaluate Auto-CoT prompting technique on SIGHT dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_cats = get_auto_cot_prediction_all_categories(
                comment=row['comment'],
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Auto-CoT evaluation on SIGHT dataset...")

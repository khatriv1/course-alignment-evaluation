...
from prompting.auto_cot import get_auto_cot_prediction, generate_auto_cot_examples
...
def evaluate_auto_cot(data_path, api_key, output_dir="results/auto_cot", limit=None):
    """Evaluate Automatic Chain of Thought prompting technique."""
    ...
    # Generate Auto-CoT examples once to reuse for all evaluations
    print("\nGenerating Auto-CoT examples...")
    examples_cache = generate_auto_cot_examples(client, num_examples=3)
    print(f"Generated {len(examples_cache)} Auto-CoT examples")
    ...
    plot_simple_metrics(
        ...
        f"{output_dir}/auto_cot_metrics.png"
    )
    
    # Print results summary
    print_simple_summary(metrics, 'Auto Chain of Thought')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Auto Chain of Thought evaluation...")

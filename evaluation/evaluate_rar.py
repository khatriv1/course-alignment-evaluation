...
from prompting.rephrase_and_respond import get_rar_prediction
...
def evaluate_rar(data_path, api_key, output_dir="results/rar", limit=None):
    """Evaluate Rephrase and Respond (RaR) prompting technique."""
    ...
    plot_simple_metrics(
        ...
        f"{output_dir}/rar_metrics.png"
    )
    
    # Print results summary
    print_simple_summary(metrics, 'Rephrase and Respond')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Rephrase and Respond evaluation...")
        print(f"Using data file: {config.DATA_PATH}")
        
        results, metrics = evaluate_rar(

...
def evaluate_few_shot(data_path, api_key, output_dir="results/few_shot", limit=None):
    """Evaluate Few-shot prompting technique."""
    ...
    plot_simple_metrics(
        ...
        results['model_scores'],
        'Few-shot',
        f"{output_dir}/few_shot_metrics.png"
    )
    
    # Print results summary
    print_simple_summary(metrics, 'Few-shot')

...
def evaluate_zero_shot(data_path, api_key, output_dir="results/zero_shot", limit=None):
    """Evaluate Zero-shot prompting technique."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            score = get_zero_shot_prediction(
                row['course_title'],
                row['description'],
    ...
    plot_simple_metrics(
        ...
        results['model_scores'],
        'Zero-shot',
        f"{output_dir}/zero_shot_metrics.png"
    )
    
    # Print results summary
    print_simple_summary(metrics, 'Zero-shot')

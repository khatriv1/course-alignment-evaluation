...
from prompting.cot import get_cot_prediction
...
def evaluate_cot(data_path, api_key, output_dir="results/cot", limit=None):
    """Evaluate Chain of Thought prompting technique."""
    ...
    plot_simple_metrics(
        ...
        results['model_scores'],
        'Chain of Thought',
        f"{output_dir}/cot_metrics.png"
    )
    
    # Print results summary
    print_simple_summary(metrics, 'Chain of Thought')

...
from prompting.contrastive_cot import get_contrastive_cot_prediction
...
def evaluate_contrastive_cot(data_path, api_key, output_dir="results/contrastive_cot", limit=None):
    """Evaluate Contrastive Chain of Thought prompting technique."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            score = get_contrastive_cot_prediction(
                row['course_title'],
                row['description'],
    ...
    plot_simple_metrics(
        ...
        f"{output_dir}/contrastive_cot_metrics.png"
    )
    
    # Print results summary
    print_simple_summary(metrics, 'Contrastive Chain of Thought')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Contrastive Chain of Thought evaluation...")

...
def create_comparison_visualization(comparison_df, output_dir):
    ...
    # Adjust x-ticks
    plt.xticks(x + width * 1.5, techniques, rotation=0)
...
def run_all_evaluations(data_path, api_key, output_dir="results", limit=None):
    """Run all three prompting techniques and create comparison."""
    ...
    # Run evaluations for each technique
    techniques = {
...
if __name__ == "__main__":
    ...
    limit_input = input("\nEnter number of examples to test with "
